      ...
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" id="formEditCode" enctype="multipart/form-data">
                <div class="form-add-file">
                    <div class="form-group">
                        <label for="code">Gift Code</label>
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="code" name="code" placeholder="Nhập gift code..." value="{{$giftcode->code}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="item_id" name="item_id" placeholder="Danh sách item..." value="{{str_replace('","',', ', trim($giftcode->item_id, '[""]'))}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="item_quantity" name="item_quantity" placeholder="Danh sách Số lượng từng item..." value="{{str_replace('","',', ', trim($giftcode->item_quantity, '[""]'))}}">
                    </div>
                    <div class="form-group">
                        <label for="item_isLock">Trạng thái từng item (0: không khoá - 1: khoá)</label>
                        <span style="color: blue;">vd: 0,0,0,1</span>
                        <input type="text" class="form-control" id="item_isLock" name="item_isLock" placeholder="Trạng thái từng item..." value="{{str_replace('","',', ', trim($giftcode->item_isLock, '[""]'))}}" >
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="item_expires" name="item_expires" placeholder="Hạn sử dụng từng item..." value="{{str_replace('","',', ', trim($giftcode->item_expires, '[""]'))}}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="player" name="player" placeholder="Danh sách tài khoản được nhận..." value="{{str_replace('","',', ', trim($giftcode->player, '[""]'))}}">
                    </div>
                    <div class="form-group">
                        <label for="time">Hạn sử dụng code (bỏ trống là không giới hạn thời gian)</label>
                        <input  style="width: 20%;" type="datetime-local" class="form-control" id="time" name="time" placeholder="Hạn sử dụng code..." value="{{$giftcode->time}}">
                    </div>
                    <hr>
                </div>
                <a id="editGiftCode" data-url="{{route('admin.postEditCode', ['id' => $giftcode->id])}}" class="btn btn-success me-2">Cập nhật</a>
...
$('#randomCode').click(function(e) {
    ...
    $('#editGiftCode').click(function(e) {
            e.preventDefault();
            $('.page-loading').removeClass('hidden');
            var url = $(this).attr('data-url');
            var type = 'POST';
            var form_data = $('#formEditCode').serializeArray();

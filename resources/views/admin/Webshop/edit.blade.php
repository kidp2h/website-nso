...
<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Sửa vật phẩm Webshop</h4>
            <form class="forms-sample" id="formAdd" enctype="multipart/form-data">
                <div class="form-add-file">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ten_vat_pham" name="ten_vat_pham" placeholder="Nhập tên vật phẩm..." value="{{$webshop->ten_vat_pham}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="gia_coin" name="gia_coin" value="{{$webshop->gia_coin}}">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="chi_tiet_game" name="chi_tiet_game" placeholder="vd: " value="{{$webshop->chi_tiet_game}}">
                    </div>
                    <div class="form-group">
                        <label for="chi_tiet_webshop">Mô tả</label>
                        <textarea name="chi_tiet_webshop" id="content" cols="30" rows="100">
                            {{$webshop->chi_tiet_webshop}}
                        </textarea>
                ...
                <a id="editWebshop" data-url="{{route('admin.postEditWebshop', ['id' => $webshop->id])}}" class="btn btn-success me-2">Cập nhật</a>

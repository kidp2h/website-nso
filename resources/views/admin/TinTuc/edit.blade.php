        ...
        <div class="col-md-8 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="Nhập tiêu đề bài viết" value="{{$news->title}}">
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body cus-card">
            ...
            <textarea  class="form-control" id="short_content" name="short_content">{{$news->short_content}}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-12"><img id="blah" src="{{asset($news->image)}}" alt="" width="300" height="300" /></div>
            </div>
            <div class="btn-add">
                <a id="editNews" style="width: 100%;" data-url="{{route('admin.postEditNews', ['id' => $news->id])}}" class="btn btn-success me-2">Sửa bài viết</a>
            </div>
          </div>
        </div>
      </div>
